function CompetenceController($scope, $state) {
    ...
    Competences.DefaultTechniques = (Competences.DefaultSwitch ==0) ? false : true;
    Competences.DefaultSelect = $state.params.refCompetence;
    if (Competences.DefaultSwitch == 0) {
        Competences.Items = Competences.Humaines;
    } else {
        Competences.Items = Competences.Techniques;
    }
...
function getCompetenceHumaine1() {
    ...
    var comp1 = {
        Id: 1,
        MenuActif: 0,
        Name: "Médiatrice/diplomate",
        Contexte:
            "Bla blablalblalblalblalballla",
        Description: "Une desc",
        Projets: [
            {
                Libelle: "Web api : Check your smile",
                Id: 1
            },
            {
                Libelle: "Web api : Meeting tracker",
                Id: 2
            }
        ]
    };
